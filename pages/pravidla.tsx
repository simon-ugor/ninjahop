  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={inter.className} style={{"textAlign": "center", "marginBottom": "1vh", "fontWeight": "bold"}}>Ako získať výhru 25 000€?</p>
        <p className={inter.className} style={{"textAlign": "center", "marginBottom": "1vh"}}>Body do tabuľky zbieraš každý deň a celý mesiac. Čím viac hráš = tým viac bodov máš. Čím viac bodov máš = tým väčšia je tvoja šanca na výhru. Na konci každého mesiaca sa hráč s najvyšším počtom bodov stáva víťaz a získava odmenu 25 000€. Bodová tabuľka sa vynuluje vždy prvý deň v mesiaci o 00:00.</p>
        <p className={inter.className} style={{"textAlign": "center", "marginBottom": "1vh", "fontWeight": "bold"}}>Ako sa stať ultimátny šampión?</p>
        <p className={inter.className} style={{"textAlign": "center", "marginBottom": "1vh"}}>Po vynulovaní tabuľky hra pokračuje ďalej a zbieraš nové body v novom mesiaci. Po 3 mesiacoch sa tvoje body zrátajú dokopy a môžeš sa stať ultimátny šampión a získať rozprávkovú výhru 100 000€.</p>
